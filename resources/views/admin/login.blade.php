                ...
                <form class="form" method="" action="">
                    ...
                    <div class="content">
                        <div class="input-group form-group-no-border input-lg">
                            ...
                            <input type="text" class="form-control u_name" name="u_name" placeholder="">
                        </div>
                        <div class="input-group form-group-no-border input-lg">
                                <span class="input-group-addon">
                                    <i class="now-ui-icons text_caps-small"></i>
                                </span>
                            <input type="text" name="u_password" placeholder="" class="form-control u_password" />
                        </div>
                    </div>
                    <div class="footer text-center btn_yes">
                        <a href="#pablo" class="denglu btn btn-primary btn-round btn-lg btn-block btn_yes">Get Started</a>
                    </div>
                    <div class="pull-left">
                        <h6>
